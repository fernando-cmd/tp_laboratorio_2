...
namespace VistaFabrica
{
    public partial class frmFabricarClasico : Form
    {
        ...
        public frmFabricarClasico(string nombre):this()
        {
            ...
            try
            {
                if (numericUpDown1.Value > 0)
                {
                        ...
                        StockInsumos.ValidarStockLentes((ELente)cmbBoxLente.SelectedItem, (int)numericUpDown1.Value))
                    {
                        ...
                        anteojo = new Clasico(desmontable, (int)numericUpDown1.Value, (EArmazon)cmbBoxArmazon.SelectedItem, (ELente)cmbBoxLente.SelectedItem, bifocal, blueRay);
